                    ...
                    >
                        ...
                        <div className={`md:flex items-center justify-between gap-12 ${index % 2 === 0 ? 'flex-row-reverse' : ''}`}>
                            ...
                            <div className="flex-1 group">
                                <div className="bg-card/30 border border-border/30 p-8 rounded-3xl backdrop-blur-md hover:bg-card/50 transition-all duration-500 hover:border-primary/30 hover:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.15)] group-hover:-translate-y-2 relative overflow-hidden">
                                    {/* Gradient Overlay */}
